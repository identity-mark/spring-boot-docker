...
[DEBUG] Using configfile: /Users/markdenmar/.docker/config.json
[DEBUG] /Users/markdenmar/.docker/ca.pem, /Users/markdenmar/.docker/key.pem or /Users/markdenmar/.docker/cert.pem does not exist, not using SSL
[WARNING] Dockerfile already exists
[INFO] Image will be built as [your_domain_name]/gs-spring-boot-docker:latest
[INFO]
